...
{
	private static readonly Logger Log = new Logger("BlackHoleProjectile");
	...
	private void OnTriggerEnter(Collider other)
	{
		...
		Log.Info($"BlackHole OnTriggerEnter <b>{other.name}</b> for target: <b>{target}</b>", (IEnumerable<Tag>)null, (string)null, (object)null);
	...
	public void Explode()
	{
		Log.Info("Explode. FadeIn: " + fadingIn, (IEnumerable<Tag>)null, (string)null, (object)null);
