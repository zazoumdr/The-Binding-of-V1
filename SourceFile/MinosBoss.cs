...
public class MinosBoss : EnemyScript
{
	...
	private void SetSpeed()
	{
		...
		foreach (Parasite obj2 in array)
		{
			obj2.speedMultiplier = eid.totalSpeedModifier;
			obj2.damageMultiplier = eid.totalDamageModifier;
		}
	}
	...
	public void SpecialDeath()
	{
		...
		Object.Instantiate(bigHurtSound, head).GetComponent<AudioSource>().SetPitch(0.75f);
