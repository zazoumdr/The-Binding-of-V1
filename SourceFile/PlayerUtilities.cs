...
public class PlayerUtilities : MonoSingleton<PlayerUtilities>
{
	...
	{
		if ((bool)(Object)(object)detachedWhoosh)
		{
			Object.Destroy(((Component)(object)detachedWhoosh).gameObject);
		}
		detachedWhoosh = MonoSingleton<NewMovement>.Instance.DuplicateDetachWhoosh();
		FadeOut fadeOut = ((Component)(object)detachedWhoosh).gameObject.AddComponent<FadeOut>();
		fadeOut.auds = (AudioSource[])(object)new AudioSource[1] { detachedWhoosh };
		fadeOut.speed = 0.1f;
	}
	...
	public void RestoreFallingWhoosh()
	{
		if ((bool)(Object)(object)detachedWhoosh)
		{
			AudioSource obj = MonoSingleton<NewMovement>.Instance.RestoreWhoosh();
			obj.time = detachedWhoosh.time;
