...
public static class ShaderProperties
{
	...
	public static readonly int SurfaceType = PrefixedPropertyToID("", "SurfaceType");

	public static readonly int SecondarySurfaceType = PrefixedPropertyToID("", "SecondarySurfaceType");

	public static readonly int EnviroParticleColor = PrefixedPropertyToID("", "EnviroParticleColor");

	public static readonly int SecondaryEnviroParticleColor = PrefixedPropertyToID("", "SecondaryEnviroParticleColor");

	public static readonly int ClipPlaneCount = PrefixedPropertyToID("", "ClipPlaneCount");

	public static readonly int ClipPlanes = PrefixedPropertyToID("", "ClipPlanes");
