...
public class PriorityQueue<TElement, TPriority>
{
	...
	{
		public struct Enumerator(PriorityQueue<TElement, TPriority> queue) : IEnumerator<(TElement Element, TPriority Priority)>, IEnumerator, IDisposable
		{
			private readonly PriorityQueue<TElement, TPriority> _queue = queue;

			private readonly int _version = queue._version;

			private int _index = 0;

			private (TElement, TPriority) _current = default((TElement, TPriority));
